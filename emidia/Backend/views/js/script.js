$(window).on("load", function() {
    ...
    $("#not-box-open1").on("click", function(){
        $("#n1").toggleClass("active");
        if(a==0) a++;
        else a-- ;
        if (b==1) {$("#n2").toggleClass("active");
                    b--;}
        if (c==1) {$(".user-account-settingss").toggleClass("active");
                    c--;}
    });

    $("#not-box-open2").on("click", function(){
        $("#n2").toggleClass("active");
        if(b==0) b++;
        else b-- ;
        if (a==1) {$("#n1").toggleClass("active");  
                    a--;}
        if (c==1) {$(".user-account-settingss").toggleClass("active");
                    c--;}
    });
